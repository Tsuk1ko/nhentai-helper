...
(function ($, vue, elementPlus) {
  ...
  var require_main_001 = __commonJS({
    "main-BRVzliXD.js"(exports, module) {
      var _worker;
...
${EXPORT_HEADER_TITLE_PRETTY}${prettyTitles.join(EXPORT_SEPARATOR)}`;
        ...
        setup(__props, { expose: __expose }) {
          ...
          return (_ctx, _cache) => {
            return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElDialog), {
              ...
              "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => show.value = $event),
              center: true,
              top: "50px"
            }, {
      ...
      const SettingsDialog = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-80cacbe9"]]);
