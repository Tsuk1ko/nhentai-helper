...
// @require            https://unpkg.com/element-plus@2.7.4/dist/index.full.min.js
// @require            https://unpkg.com/jquery@3.7.1/dist/jquery.min.js
// @resource           element-plus-css  https://unpkg.com/element-plus@2.7.4/dist/index.css
// @connect            nhentai.net
...
(function ($, vue, elementPlus) {
  ...
  var require_main_001 = __commonJS({
    "main-CJcT6Jtp.js"(exports, module) {
...
${xml}`;
      ...
      class IgnoreController {
        constructor(text = true, status = false) {
          ...
          if (text)
            this.text = /* @__PURE__ */ core.h("span", null, this.btnText);
      ...
      const _sfc_main = /* @__PURE__ */ vue.defineComponent({
        ...
        setup(__props, { expose: __expose }) {
          const TAG_TYPES = ["parody", "tag", "artist", "language", "category"];
          ...
          const galleryLink = vue.computed(() => {
            var _a;
            return `https://nhentai.net/g/${(_a = gallery2.value) == null ? void 0 : _a.id}/`;
          });
          ...
          const getThumbInfo = ({ t: t22, w, h: h2 }, i) => {
            var _a;
            return {
              url: `https://t3.nhentai.net/galleries/${(_a = gallery2.value) == null ? void 0 : _a.media_id}/${i + 1}t.${NHentaiImgExt[t22]}`,
              height: w && h2 ? Math.floor(pageThumbWidth.value * h2 / w) : 0
            };
          };
          ...
          const openTagUrl = (path) => {
            if (!path)
              return;
            _GM_openInTab(`https://nhentai.net${path}`, { active: true, setParent: true });
          };
          let loadingGid = "";
          const open2 = async (el, gid2) => {
            var _a, _b, _c;
            if (virtualRef.value === el)
              return;
          ...
          const addPageThumbLine = () => {
            ...
            if (curLength >= gallery2.value.images.pages.length)
              return;
                    ...
                    default: vue.withCtx(() => [
                      ...
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(groupedTags.value, ([type, tags2]) => {
                        return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElDescriptionsItem), { key: type }, {
                          ...
                          default: vue.withCtx(() => [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tags2, (tag) => {
                              return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElTag), {
                                ...
                                default: vue.withCtx(() => [
                                  ...
                                  vue.createTextVNode(" | " + vue.toDisplayString(formatNumber(tag.count || 0)), 1)
                                ]),
                                _: 2
                              }, 1032, ["onClick"]);
                            }), 128))
      ...
      const GalleryMiniPopover = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c1f14028"]]);
      const initApp = once(
      ...
      const initGallery = function() {
        ...
        this.addEventListener("contextmenu", (e) => {
          if (!settings.galleryContextmenuPreview)
            return;
          e.preventDefault();
