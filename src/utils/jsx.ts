// https://github.com/kartiknair/dhow/blob/master/src/jsx-runtime.js
...
export const createElement = (
  ...
  ...children: Array<HTMLElement | string | Array<HTMLElement | string>>
): HTMLElement => {
  ...
  Object.entries(props ?? {}).forEach(([name, value]) => {
    ...
    else if (name === 'class') element.classList.add(String(value));
