...
import { init } from './utils/initPage';
import { lastDownload } from './utils/lastDownload';
...
GM_registerMenuCommand(i18n.global.t('menu.restoreLastDownload'), () => lastDownload.restore());
